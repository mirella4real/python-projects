...
app_window.config(padx=50, pady=50, background=GREEN)

app_canvas = Canvas(width=800, height=526, bg=GREEN, highlightthickness=0)
...
wrong_button = Button(image=wrong_image, highlightbackground=GREEN, highlightthickness=0)
wrong_button.grid(column=0, row=1)

right_image = PhotoImage(file="./images/right.png")
right_button = Button(image=right_image, highlightbackground=GREEN, highlightthickness=0)
